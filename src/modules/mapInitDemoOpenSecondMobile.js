...
Microsoft.Maps.loadModule('Microsoft.Maps.Directions', function () {
    ...
    var startWaypoint = new Microsoft.Maps.Directions.Waypoint({ address: 'start', location: new Microsoft.Maps.Location(55.797289, 37.930846) });
    directionsManager.addWaypoint(startWaypoint);

    var endWaypoint = new Microsoft.Maps.Directions.Waypoint({ address: 'end', location: new Microsoft.Maps.Location(55.677224, 37.892168) });
...
// метка на карте, с infobox
    ...
    function AddInfoboxBtn_Tapped() {
        map.entities.clear();
        //Создаем метку 
        var pin = new Microsoft.Maps.Pushpin(new Microsoft.Maps.Location(55.807261, 37.839398), {
            icon: '../img/mark-p.svg',
            width: 45,
            height: 38
        });
        var pinMan = new Microsoft.Maps.Pushpin(new Microsoft.Maps.Location(55.713601, 37.834490), {
            icon: '../img/man-mark.svg',
            width: 45,
            height: 38
        });
        var car = new Microsoft.Maps.Pushpin(new Microsoft.Maps.Location(55.797448, 37.928561), {
            icon: '../img/car-open1.svg',
            width: 50,
            height: 22
        });
        pinMan.Metadata = {
